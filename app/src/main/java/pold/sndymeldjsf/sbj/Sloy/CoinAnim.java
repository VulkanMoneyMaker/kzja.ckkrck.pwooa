...
/***************************************************************************************************************************************************************************************************************/
	public CoinAnim(){
		super(Resursi._getImg("Buttons/usd3"));
		Resursi.setScale(this);
		initVar();	
		schedule("firstAction", 1.0f / 60.0f);		
	}
/***************************************************************************************************************************************************************************************************************/
	public void initVar(){
		float nVelXRes = Resursi._getX(3.0f);
		float nVelYRes = Resursi._getY(5.0f);
		m_fGravity = Resursi._getX(3.0f);
		m_fVx = Resursi._getX(20.0f) + MathLib.random(0, nVelXRes);
		m_fVy = Resursi._getX(20.0f) + MathLib.random(0, nVelYRes);
		m_nTime = 0;
		setScale(0.1f);
	}		
/***************************************************************************************************************************************************************************************************************/
	public void firstAction(float dt){
		...
		if(getPosition().y < Resursi._getY(90)){
			m_nTime = 0 ;
			m_fVy = -1.5f * m_fVy;
			m_fVx = -(getPosition().x - Resursi._getX(250f)) / ((CCDirector.sharedDirector().winSize().height - Resursi._getY(40.0f)) / m_fVy);
...
/***************************************************************************************************************************************************************************************************************/
	public void secondAction(float dt){
		...
		if(getPosition().y > CCDirector.sharedDirector().winSize().height - Resursi._getY(40)){
			setVisible(false);
