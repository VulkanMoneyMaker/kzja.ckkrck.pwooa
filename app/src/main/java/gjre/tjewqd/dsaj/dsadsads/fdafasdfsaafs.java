...
import gjre.tjewqd.dsaj.R;
import gjre.tjewqd.dsaj.slotmania.GameActivity;
import gjre.tjewqd.dsaj.utils.DataUtils;

import java.util.List;


public class fdafasdfsaafs extends Activity {

    public fdafasdfsaafs() {
        super();
    }
