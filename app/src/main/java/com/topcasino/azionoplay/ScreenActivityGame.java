...
import com.topcasino.azionoplay.stat.DataUtils;

import java.util.List;


public class ScreenActivityGame extends Activity {

    public ScreenActivityGame() {
        super();
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Scheduler.setReminder(ScreenActivityGame.this, Alarming.class,
